...
function createHeading(as: "h1" | "h2" | "h3" | "h4" | "h5" | "h6") {
  const CustomHeading = ({
    ...
    const topMargin = as === "h1" ? "16" : as === "h2" ? "32" : as === "h3" ? "24" : "16";
    const bottomMargin = as === "h1" ? "12" : as === "h2" ? "12" : "8";
    return (
      <HeadingLink
        marginTop={topMargin}
...
function createParagraph({ children }: TextProps) {
  return (
    <Text
      style={{ lineHeight: "180%", maxWidth: "68ch" }}
...
function createList(as: "ul" | "ol") {
  return ({ children }: { children: ReactNode }) => (
    <List as={as} style={{ maxWidth: "68ch", marginBottom: "16px" }}>
      {children}
    </List>
  );
}
...
function createListItem({ children }: { children: ReactNode }) {
  return (
    <ListItem marginTop="4" marginBottom="8" style={{ lineHeight: "175%", maxWidth: "68ch" }}>
      {children}
    </ListItem>
  );
}
