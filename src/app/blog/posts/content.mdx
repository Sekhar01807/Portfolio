...
`const social = [
    ...
    },
    {
      name: "Email",
      icon: "email",
      link: "mailto:sekharsekhar1919@gmail.com",
    },
];`,
    language: "tsx",
    label: "src/app/resources/content.js"
...
`const home = {
    label: "Home",
    title: "Sekhar Reddy — Software Engineer",
    description: "Software engineer building secure, production-oriented full-stack systems",
    headline: <>Building secure, production-oriented full-stack systems</>,
    subline: (
      <>
        Software engineer building secure, production-oriented full-stack systems across
        <br /> real-time communication, financial workflows, SaaS, payments, and databases.
      </>
    ),
};`,
    language: "tsx",
